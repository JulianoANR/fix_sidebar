                        ...
                        <div class="px-4 pb-4 pb-md-4 px-md-5">
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control-auth rounded-pill" id="email" name="" type="email" placeholder="">
                                </div>

                                <div class="form-group mb-5">
                                    <label class="pl-3 text-white" for="password">Password <i class="ml-1 fa-solid fa-lock"></i></label>
                                    <input class="form-control-auth rounded-pill" id="password" name="" type="password" placeholder="">
                                </div>
